  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Acceptors Information</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Information</a></li>
              <li class="breadcrumb-item active">Acceptors</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <div class="row" style="padding: 10px 20px;">
                    <div class="col-md-6 col-sm-6 col-6">
                      <h3 class="card-title">Acceptors Information</h3> 
                    </div>
              ...
              <div class="card-body">
                ...
                <br>
                <center><button id="export" class="btn btn-success">Export as CSV</button></center>
...
document.querySelector("#export").addEventListener("click", function () {
  ...
  export_table_to_csv(html, "acceptors.csv");
});
    </script>
