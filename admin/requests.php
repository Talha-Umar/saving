...
if (isset($_POST['status'])) {
 ...
 $status=$_POST['status'];
$date=date('d-m-Y');
 $sql = "UPDATE requests SET status='$status',update_date='$date' WHERE id='$orderid'";
              ...
              <div class="card-header">
                <div class="row" style="padding: 10px 20px;">
                    <div class="col-md-6 col-sm-6 col-6">
                      <h3 class="card-title">Requests Information</h3> 
                    </div>
...
document.querySelector("#export").addEventListener("click", function () {
  ...
  export_table_to_csv(html, "requests.csv");
});
    </script>
